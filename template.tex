...
\date{Leipzig, June 2023}
\title{IMISE Student \LaTeX{} Beamer Theme v3. The title can use three lines but doesn't have to.}
...
\item Compile with xelatex or [tectonic](https://github.com/tectonic-typesetting/tectonic)
\item pdflatex works too but doesn't include the custom font. pdflatex twice the first time to get the graphical elements correct.
\end{enumerate}
\end{frame}
